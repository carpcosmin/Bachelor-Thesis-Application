...
public final class FragmentFavoritesBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvFavoriteOffers;

  private FragmentFavoritesBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rvFavoriteOffers) {
    this.rootView = rootView;
    this.rvFavoriteOffers = rvFavoriteOffers;
  }
  ...
  public static FragmentFavoritesBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.rv_favoriteOffers;
      RecyclerView rvFavoriteOffers = ViewBindings.findChildViewById(rootView, id);
      if (rvFavoriteOffers == null) {
        break missingId;
      }

      return new FragmentFavoritesBinding((ConstraintLayout) rootView, rvFavoriteOffers);
    }
